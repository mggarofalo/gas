...
public class UpdateVehicleValidatorTests
{
    ...
    {
        var result = _validator.TestValidate(new UpdateVehicleRequest(2021, null, null, null));
    ...
    {
        var result = _validator.TestValidate(new UpdateVehicleRequest(1800, null, null, null));
    ...
    {
        var result = _validator.TestValidate(new UpdateVehicleRequest(null, "", null, null));
    ...
    {
        var result = _validator.TestValidate(new UpdateVehicleRequest(null, new string('X', 101), null, null));
        result.ShouldHaveValidationErrorFor(x => x.Make);
    }
    ...
    {
        var result = _validator.TestValidate(new UpdateVehicleRequest(null, "Honda", null, null));
