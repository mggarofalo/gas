  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          to="/fill-ups/new"
          className="w-full rounded-lg bg-blue-600 dark:bg-blue-500 px-4 py-2 text-center text-sm font-medium text-white shadow-sm hover:bg-blue-700 dark:hover:bg-blue-600 sm:w-auto"
        >
          New Fill-Up
        </Link>
      </div>
